...
describe("Temperature Map Component Logic", () => {
  ...
  describe("Configuration Processing", () => {
    ...
    const calculateCanvasDimensions = (
      ...
      const finalHeight =
        minY === 0 ? maxY + 1 + padding * 2 : calculatedHeight;
  ...
  describe("Sensor Data Processing", () => {
    ...
    const processSensorData = (
      ...
      hassStates: Record<
        string,
        { state: string; attributes?: { friendly_name?: string } }
      >,
    ) => {
      return sensors
        .map((sensor) => {
    ...
    it("should use entity ID as fallback label", () => {
      const sensors = [{ entity: "sensor.no_friendly_name", x: 100, y: 100 }];
    ...
    it("should handle precise temperature values", () => {
      const sensors = [{ entity: "sensor.precise", x: 100, y: 100 }];
  ...
  describe("Mouse Interaction Logic", () => {
    ...
    it("should calculate mouse position correctly", () => {
      ...
      const result = getMousePositionAndSensor(
        event,
        canvasRect,
        canvasSize,
        sensors,
  ...
  describe("Configuration Defaults", () => {
    ...
    it("should apply default values for missing optional properties", () => {
      ...
      expect(result.comfort_min_temp).toBe(20);
      expect(result.comfort_max_temp).toBe(26);
    ...
    it("should preserve explicitly set values", () => {
      ...
      expect(result.comfort_min_temp).toBe(15);
      expect(result.comfort_max_temp).toBe(30);
