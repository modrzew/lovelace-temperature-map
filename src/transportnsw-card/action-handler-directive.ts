...
const getActionHandler = (): ActionHandler => {
  ...
  if (body.querySelector('action-handler-transportnsw')) {
    return body.querySelector('action-handler-transportnsw') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-transportnsw');
